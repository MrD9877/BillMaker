...
export default function Recipt() {
    const items = useSelector(state => state.bill.items)
    const billTotal = useSelector(state => state.bill.billTotal)
    ...
    return (
        <div>
            <div onClick={print} className="flex h-screen w-full items-center justify-center bg-gray-600 flex-col">
                <div className="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
                    <div className="flex flex-col justify-center items-center gap-2">
                        <h4 className="font-semibold">Jagraon Garments</h4>
                        <p className="text-xs">Daudhar near satva darvaja</p>
                    </div>
                        ...
                        <table className="w-full text-left">
                            ...
                            {items ? items.map((item, index) => {
                                return <tbody key={index}>
                                    <tr className="flex">
                                        <td className="flex-1 py-1">{item.productName}</td>
